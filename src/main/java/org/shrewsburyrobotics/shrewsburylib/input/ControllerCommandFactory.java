...
public class ControllerCommandFactory {
  ...
  public static byte[] setLEDRGB(int index, int r, int g, int b) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.Single, (byte) index,
        ControllerDataProtocol.LightingValue.LedBaseColor, (byte) r, (byte) g, (byte) b};
  }
  ...
  public static byte[] setLEDRangeRGB(int startLED, int endLED, int r, int g, int b) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.Multiple, (byte) startLED, (byte) endLED,
        ControllerDataProtocol.LightingValue.LedBaseColor, (byte) r, (byte) g, (byte) b};
  }
  ...
  public static byte[] setLEDRangeHSB(int startLED, int endLED, float h, float s, float b) {
    java.awt.Color outColor = java.awt.Color.getHSBColor(h, s, b);
    return setLEDRangeRGB(startLED, endLED, outColor.getRed(), outColor.getGreen(),
        outColor.getBlue());
  }
  ...
  public static byte[] setLEDSectionRGB(int section, int r, int g, int b) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.Section, (byte) section,
        ControllerDataProtocol.LightingValue.LedBaseColor, (byte) r, (byte) g, (byte) b};
  }
  ...
  public static byte[] setLEDEffect(int index, int effect) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.Single, (byte) index,
        ControllerDataProtocol.LightingValue.LedEffect, (byte) effect};
  }
  ...
  public static byte[] setLEDRangeEffectSpaced(int startLED, int endLED, int effect) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.Multiple, (byte) startLED, (byte) endLED,
        ControllerDataProtocol.LightingValue.LedEffectSpaced, (byte) effect};
  }
   ...
   *
   * @param index  the LED to set the speed of
   * @param offset TODO: what does this do?
   * @return a command to set the speed
   */
  public static byte[] setLEDOffset(int index, int offset) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.Single, (byte) index,
        ControllerDataProtocol.LightingValue.LedOffset, (byte) offset};
  }
  ...
  public static byte[] setLEDSpeed(int index, int speed) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.Single, (byte) index,
        ControllerDataProtocol.LightingValue.LedSpeed, (byte) speed};
  }
  ...
  public static byte[] setAllLEDSpeed(int speed) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.All, ControllerDataProtocol.LightingValue.LedSpeed,
        (byte) speed};
  }
  ...
  public static byte[] setLEDBrightness(int index, int brightness) {
    return new byte[]{ControllerDataProtocol.CommandID.SetLed,
        ControllerDataProtocol.LightingSelection.Single, (byte) index,
        ControllerDataProtocol.LightingValue.LedBrightness, (byte) brightness};
  }
